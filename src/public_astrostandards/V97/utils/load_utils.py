...
import ObsOpsDll
import ElOpsDll
# LAMOD: The following DLLs MUST be loaded and initialized before using this DLL: DllMain, EnvConst, AstroFunc, TimeFunc, Sensor, Obs, and SatState (SatState, in turn, depends on Tle, SpVec, Vcm, Sgp4Prop, SpProp, and ExtEphem DLLs).
import LamodDll
# ROTAS: The following DLLs MUST be loaded and initialized before using this DLL: DllMain, EnvConst, AstroFunc, TimeFunc, Sensor, and SatState (SatState, in turn, depends on Tle, SpVec, Vcm, Sgp4Prop, SpProp, and ExtEphem DLLs).
import RotasDll
import BatchDCDll
import ComboDll
import ElCompDll
